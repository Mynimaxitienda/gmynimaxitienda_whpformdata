...
function miFuncion(cadenaOriginal) {
    ...
    const cadenaProcesada = eliminarCamposEspecificosSinRegex(cadenaOriginal, camposAEliminar);

    const { resultadoFinal, resultadosIntermedios } = eliminarCamposEspecificosSinRegexYAlmacenar(cadenaOriginal, camposAEliminar);
